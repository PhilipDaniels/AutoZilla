AutoTemplates
=============
Drop a template file (*.azt) into this folder to have it automatically and
bound to a hotkey. AutoZilla will paste the text when the hotkey is pressed.
You may use variables in the template, but you cannot move the cursor around
or do any other sophisticated processing - it is just "paste into current
application".
